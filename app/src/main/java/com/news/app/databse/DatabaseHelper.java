...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            + COLUMN_USER_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_USER_FIRST_NAME + " TEXT," + COLUMN_USER_LAST_NAME + " TEXT," + COLUMN_USER_ADDRESS + " TEXT,"
    ...
    public String getUserId(String email){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                userid = String.valueOf(Integer.parseInt(cursor.getString(cursor.getColumnIndex(COLUMN_USER_ID))));
            } while (cursor.moveToNext());
        }
